...
#ifndef _aspect_initial_temperature_potential_temperature_h
#define _aspect_initial_temperature_potential_temperature_h
...
namespace aspect
{
  namespace InitialTemperature
  {
    ...
    template <int dim>
    class PotentialTemperature:  public Utilities::AsciiDataInitial<dim>, public Interface<dim>
    {
      public:
        /**
         * Empty Constructor.
...
//        double lab_isotherm_temperature;
        double mantle_potential_temperature;
